...
// Optional: --expect-version <v> (default 0.8.0).
...
const SPEC = arg("--spec", "");                 // registry spec, e.g. @ecocitizenz/ecz-id-mcp-verifier@0.8.0
const TARBALL = TARBALL_ARG ? resolve(TARBALL_ARG) : "";
const OUT = arg("--out", "");
const EXPECT_VERSION = arg("--expect-version", "0.8.0");
...
try {
  ...
  // No source-tree fallback: the installed dependency must resolve to the npm registry tarball URL.
